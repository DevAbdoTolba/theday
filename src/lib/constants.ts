...
// Staging folder for video files awaiting YouTube processing (set NEXT_PUBLIC_VIDEO_STAGING_FOLDER_ID in env)
export const VIDEO_STAGING_FOLDER_ID = process.env.NEXT_PUBLIC_VIDEO_STAGING_FOLDER_ID ?? "";
